...
Press ENTER after you close the game.""",
                "modsv": "Modifying {0}...",
                "modgd": "Modifying `GameData.dat`...",
                "end": "\nFinished. Glory to mankind!\nPress enter to exit..."
            },
            u"Tagalog": {
                "gd_not_found": "Hindi makita ang GameData.dat sa folder na ito. Pakihanap at pakilagay ang mga files dito.",
...
Ito ay gagawin ng laro.
Mangyaring buksan ang laro.
Maaari mong isara ang laro kapag lumabas na ang title screen.
Huwag isara ang program na ito at bumalik dito pagkatapos gawin ang mga instruksyon.

Pindutin ang ENTER pagkatapos mong isara ang laro.""",
